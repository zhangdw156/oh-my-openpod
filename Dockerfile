...
# ---------- 3. 安装 opencode（Alpine musl 构建，需要连同依赖库一起拷贝）----------
...
# ---------- 10. 允许 git 操作挂载目录（容器 root 与宿主机 UID 不同）----------
